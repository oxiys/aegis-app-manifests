...
# 4b. Install Cilium Tetragon (eBPF Kernel Runtime Security & Sigkill)
Write-Host "Installing Cilium Tetragon for Kernel Runtime Security..." -ForegroundColor Green
